...
public:
	...
	void output( Gb_Blip_Buffer* mono );
	void output( Gb_Blip_Buffer* center, Gb_Blip_Buffer* left, Gb_Blip_Buffer* right );
	
	// Assign single oscillator output to buffer(s). Valid indicies are 0 to 3,
	// which refer to Square 1, Square 2, Wave, and Noise.
	// If buffer is NULL, silence oscillator.
	enum { osc_count = 4 };
	void osc_output( int index, Gb_Blip_Buffer* mono );
	void osc_output( int index, Gb_Blip_Buffer* center, Gb_Blip_Buffer* left, Gb_Blip_Buffer* right );
...
inline void Gb_Apu::output( Gb_Blip_Buffer* b ) { output( b, NULL, NULL ); }
	
inline void Gb_Apu::osc_output( int i, Gb_Blip_Buffer* b ) { osc_output( i, b, NULL, NULL ); }
