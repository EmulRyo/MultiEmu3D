...
#ifndef __DEBUGGERGBDIALOG_H__
#define __DEBUGGERGBDIALOG_H__
...
class DebuggerGBDialog : public wxDialog {
public:
	
    /**
     * Creates a new DebuggerDialog.
     */
    DebuggerGBDialog(wxWindow *parent, VideoGameDevice *device);
	~DebuggerGBDialog();
