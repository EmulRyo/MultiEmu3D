...
u8 Nes::GetInstructionCondicionalCycles(u8 opcode) {
    return instructionCondicionalCycles[opcode];
}

u8 Nes::GetInstructionCyclesCB(u8 opcode) {
    return instructionCyclesCB[opcode];
}

u8 Nes::GetInstructionCyclesED(u8 opcode) {
    return instructionCyclesED[opcode];
}

u8 Nes::GetInstructionCondicionalCyclesED(u8 opcode) {
    return 16;
}

u8 Nes::GetInstructionCyclesXD(u8 opcode) {
    return instructionCyclesXD[opcode];
}

u8 Nes::GetInstructionCyclesXDCB(u8 opcode) {
