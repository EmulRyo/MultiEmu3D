...
public:
	...
	struct channel_t {
		Gb_Blip_Buffer* center;
		Gb_Blip_Buffer* left;
		Gb_Blip_Buffer* right;
	};
...
public:
	...
	Gb_Blip_Buffer* center() { return &buf; }
...
class Gb_Stereo_Buffer : public Multi_Buffer {
public:
	Gb_Stereo_Buffer();
	~Gb_Stereo_Buffer();
	
	// Buffers used for all channels
	Gb_Blip_Buffer* center()       { return &bufs [0]; }
	Gb_Blip_Buffer* left()         { return &bufs [1]; }
	Gb_Blip_Buffer* right()        { return &bufs [2]; }
...
inline long Gb_Stereo_Buffer::samples_avail() const { return bufs [0].samples_avail() * 2; }

inline Gb_Stereo_Buffer::channel_t Gb_Stereo_Buffer::channel( int index ) { return chan; }
